	...
	public class Tween extends Transition
	{
		...
		protected override function setup():void
		{
			...
			for (var name:String in _values) {
				...
				v1 = _values[name];
				//if (name == "visible"&&(_target is NodeSprite) && (_target.type == NodeSprite.ANCESTOR))
					//trace("TWEEN ("+_target.data.name+","+v0+","+v1+")");
//				if (_target is BlockSprite){
//					trace("TWEEN ("+_target.focus.data.name+","+v0+","+v1+")");
//				}
				if (vc != v1 || vc != v0) {
					if (name == "visible") {
