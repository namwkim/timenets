package genvis.vis.data
{
	...
	import genvis.scale.LogScale;
	import genvis.scale.OrdinalScale;
	import genvis.scale.QuantileScale;
	import genvis.scale.QuantitativeScale;
	import genvis.scale.RootScale;
